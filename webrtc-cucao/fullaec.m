...
clc;clear;
% fid=fopen('speaker.pcm', 'rb'); % Load far end
fid=fopen('ref_signal_8k.pcm', 'rb'); % Load far end
...
% fid=fopen('micin.pcm', 'rb'); % Load near end
fid=fopen('mic_signal_8k.pcm', 'rb'); % Load near end
...
% ¶ÁÈ¡ wav
[rrin ,fs1] = audioread('ref8k.wav');
[ssin ,fs2] = audioread('mic8k.wav');
...
%surf(overdriveM);
%shading interp;
audiowrite('aec-out-full.wav',ercn,8000);
figure(10);
t = (0:Nb)*N/fs;
